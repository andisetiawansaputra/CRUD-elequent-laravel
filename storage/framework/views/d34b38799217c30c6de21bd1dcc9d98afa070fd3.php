<?php $__env->startSection('judul', 'CRUD | Edit'); ?>
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="form-group row dropdown mb-0">
                ...
                <div class="col-sm-10">
                    ...
                    <a role="button" id="namadosen" class="custom-select col-md-6 " onclick="drop('selectdosen')"><?php echo e($mahasiswa->dosen->nama); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <input type="submit" name="Submit" class="btn btn-dark btn-outline-light" value="Edit Data"></input>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CRUD\resources\views/edit.blade.php ENDPATH**/ ?>